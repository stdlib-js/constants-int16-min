...
```javascript
INT16_MIN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-int16-min@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-int16-min/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-int16-min/actions/workflows/test.yml?query=branch:v0.2.3
