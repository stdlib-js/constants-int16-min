...
```javascript
INT16_MIN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-int16-min@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-int16-min@umd/bundle.js"></script>
```
